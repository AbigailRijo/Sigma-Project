...
namespace SigmaWebService.Service
{
    ...
    {
        BookingAvailability Getavailability(BookingForm _bookingForm);
    }
    public class SigmaBookingService : ISigmaBookingService
    {
        public BookingAvailability Getavailability(BookingForm _bookingForm)
        {
            BookingAvailability Availability = new BookingAvailability();

            try
            {
                Availability = new BookingAvailability
                {
